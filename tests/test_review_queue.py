...
def test_u93_connection_sets_busy_timeout_and_journal_limits(tmp_path):
    """U93: every queue connection carries the U45-class hardening pragmas."""
...
def test_u93_enqueue_lands_under_external_holder_with_wide_margin(tmp_path):
    """U93 parity reproducer: a queue write under an external EXCLUSIVE holder.
    ...
    raising OperationalError (the pre-U93 behaviour: default 5s timeout, no
